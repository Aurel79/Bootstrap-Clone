    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
        ...
        <div class="container py-2 px-4">
            ...
            <a href="#" class="navbar-brand mb-0 h1">
                <img class="img-fluid" src="{{ asset('resources/images/logo-white.svg') }}" alt="logo" style="width: 40px;">
            </a>
            <!-- Navbar Toggler -->
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-md-5 order-md-2">
                    <img class="img-fluid" src="{{ asset('resources/images/main.svg') }}" alt="main logo">
                </div>
    ...
    <div id="bs-icons">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ asset('resources/images/bs-icons.png') }}" alt="Bootstrap Icons">
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="bs-themes">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ asset('resources/images/bs-themes.png') }}" alt="Bootstrap Themes">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="#" class="logo text-decoration-none">
                        <div class="d-flex">
                            <img class="img-fluid" src="{{ asset('resources/images/logo-black.svg') }}" alt="Bootstrap Logo" style="width: 40px;">
